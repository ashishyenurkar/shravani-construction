    ...
    <div className="completed-projects-section">
      ...
      <marquee className="project-scroll" behavior="scroll" direction="left" scrollamount="5">
        <div className="project">
          <img src="https://ktgy.com/wp-content/uploads/2017/10/The-Theo-2.jpg" alt="Project 1" />
          <p>Description of Project 1</p>
        </div>
        <div className="project">
          <img src="http://nemanigroup.in/images/banner/projects.png" alt="Project 2" />
          <p>Description of Project 2</p>
        </div>
        <div className="project">
          <img src="https://www.dptconstructionca.com/app/uploads/2015/01/1A12.jpg" alt="Project 3" />
